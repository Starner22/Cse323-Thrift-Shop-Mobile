...
const Personal_Moderation_History = ({ navigation }: any) => {
                ...
                <View style={styles.cardBody}>
                    {item.target_user && (
                        <View style={styles.targetContainer}>
                            ...
                            <Text style={styles.targetId}>#{item.target_user.userID}</Text>
                        </View>
                    )}
                    {item.target_product && (
                        <View style={styles.targetContainer}>
                            ...
                            <Text style={styles.targetId}>#{item.target_product.productID}</Text>
                        </View>
                    )}
                </View>
            </TouchableOpacity>
    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.topBar}>
                ...
                <Text style={styles.storeTitle}>My Moderation History</Text>
            ...
            {loading ? (
                ...
                <View style={styles.emptyContainer}>
                    ...
                    <Text style={styles.emptySubtext}>
                        {filter === 'all' 
                            ? 'You haven\'t performed any moderation actions yet.' 
...
export default Personal_Moderation_History;